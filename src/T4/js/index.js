...
$(function(){
	...
	*/
	...
	$('.btn-up').on('syncBtnUpClick', function (e) {
		...
		// console.log('c-page-up:============================' + contentUp);
	...
	$('.btn-down').on('syncBtnDownClick', function () {
		...
		// console.log('c-page-down:============================' + contentUp);
	...
	// pics.each(function (i, ele) {
		...
		var itemClick = true;
		$('.problem-area .pic li').on('click touchstart',function(e){
			// debugger;
			e.stopPropagation();
	        if (itemClick) {
	            itemClick = false;
		...
		$('.problem-area .pic li').on('syncSoundClick', function () {
	...
	// items.each(function (i, ele) {
		$('.problem-area .answers li').on('syncSoundClick', function () {
